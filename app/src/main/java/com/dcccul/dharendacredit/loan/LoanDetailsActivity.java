...
//            productName.setText(pName);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId()== R.id.culturalAcademyItemId){
            Intent intent = new Intent(LoanDetailsActivity.this, CulturalAcademyActivity.class);
            startActivity(intent);

        } else if (item.getItemId()== R.id.contactUsItemId) {
            Intent intent = new Intent(LoanDetailsActivity.this, ContactUsActivity.class);
            startActivity(intent);
        }
