package com.dcccul.dharendacredit.presidentsspeech;
...
public class PresidentsSpeechActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_presidents_speech);
        WebView webView;
        android.support.v7.widget.Toolbar toolbar;

        webView = findViewById(R.id.webViewId_inPresidentSpeechActivity);
        ...
        String fileName = "file:///android_asset/President's Speech.html";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId()== R.id.culturalAcademyItemId){
            Intent intent = new Intent(PresidentsSpeechActivity.this, CulturalAcademyActivity.class);
            startActivity(intent);

        } else if (item.getItemId()== R.id.contactUsItemId) {
            Intent intent = new Intent(PresidentsSpeechActivity.this, ContactUsActivity.class);
            startActivity(intent);
        }
